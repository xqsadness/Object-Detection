...
struct LiveFeedViewController: UIViewControllerRepresentable {
    typealias UIViewControllerType = LiveFeedController
    
    func makeUIViewController(context: Context) -> LiveFeedController {
        return LiveFeedController()
    }
    
    func updateUIViewController(_ uiViewController: LiveFeedController, context: Context) {
        // Nothing to update here
    }
}

class LiveFeedController: UIViewController {
...
extension LiveFeedController: AVCaptureVideoDataOutputSampleBufferDelegate {
